...
const PrivacyPolicy = () => (
  <div className="max-w-3xl mx-auto px-4 py-12">
    ...
    <p className="mb-4 text-gray-700">
      At {COMPANY_NAME}, your privacy is our top priority. We are committed to
      protecting your personal information and ensuring a safe, confidential
    ...
    <p className="mb-4 text-gray-700">
      ...
      information at any time. To do so, please contact us at {CONTACT_EMAIL}.
    </p>
    <h2 className="text-xl font-semibold mt-8 mb-2 text-gray-900">
      Contact Us
    </h2>
